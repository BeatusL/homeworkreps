...
//altmult_complex CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" IMPLEMENTATION_STYLE="AUTO" PIPELINE=4 REPRESENTATION_A="UNSIGNED" REPRESENTATION_B="UNSIGNED" WIDTH_A=18 WIDTH_B=18 WIDTH_RESULT=36 aclr clock dataa_imag dataa_real datab_imag datab_real ena result_imag result_real
...
//synthesis_resources = altmult_add 2 reg 72 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  GOOOOOOOOOOL_altmult_complex_agq
	( 
	aclr,
	clock,
	dataa_imag,
...
`endif
	...
	defparam
		...
		mult_add1.representation_a = "UNSIGNED",
		mult_add1.representation_b = "UNSIGNED",
	...
	defparam
		...
		mult_add2.representation_a = "UNSIGNED",
		mult_add2.representation_b = "UNSIGNED",
	...
	assign
		...
		result_imag = result_imag0c,
		result_real = result_real0c;
endmodule //GOOOOOOOOOOL_altmult_complex_agq
//VALID FILE
...
module GOOOOOOOOOOL (
	...
	GOOOOOOOOOOL_altmult_complex_agq	GOOOOOOOOOOL_altmult_complex_agq_component (
				.aclr (aclr),
				.clock (clock),
