...
main(void) {
	...
	if ((shmid_1 = shmget(IPC_PRIVATE, SHM_SIZE, IPC_CREAT | 0666)) == -1) {
		perror("shmget shmid_1");
		exit(1);
	}
	if ((shmid_2 = shmget(IPC_PRIVATE, SHM_SIZE, IPC_CREAT | 0666)) == -1) {
		perror("shmget shmid_2");
		exit(1);
	}
	if ((shmid_3 = shmget(IPC_PRIVATE, SHM_SIZE, IPC_CREAT | 0666)) == -1) {
